...
static const TIM_Base_InitTypeDef tim_2_4_time_base = {
	.Prescaler = (PIOS_PERIPHERAL_APB1_CLOCK / 1000000) - 1,
...
static const TIM_Base_InitTypeDef tim_8_9_time_base = {
	.Prescaler = (PIOS_PERIPHERAL_APB2_CLOCK / 1000000) - 1,
	.ClockDivision = TIM_CLOCKDIVISION_DIV1,
	.CounterMode = TIM_COUNTERMODE_UP,
	.Period = 0xFFFF,
	.RepetitionCounter = 0x0000,
...
static const TIM_Base_InitTypeDef tim_3_time_base = {
	.Prescaler = (PIOS_PERIPHERAL_APB1_CLOCK / 1000000) - 1,
	.ClockDivision = TIM_CLOCKDIVISION_DIV1,
	.CounterMode = TIM_COUNTERMODE_UP,
	.Period = ((1000000 / PIOS_SERVO_UPDATE_HZ) - 1),
	.RepetitionCounter = 0x0000,
};

// Set up timers that only have inputs on APB2
static const TIM_Base_InitTypeDef tim_1_time_base = {
	.Prescaler = (PIOS_PERIPHERAL_APB2_CLOCK / 1000000) - 1,
	.ClockDivision = TIM_CLOCKDIVISION_DIV1,
	.CounterMode = TIM_COUNTERMODE_UP,
	.Period = ((1000000 / PIOS_SERVO_UPDATE_HZ) - 1),
