...
void PIOS_Board_Init(void) {
	...
	if (boot_count < 3) {
		...
		HwFlyingF7SetDefaults(HwFlyingF7Handle(), 0);
	...
	HwFlyingF7USB_VCPPortGet(&hw_usb_vcpport);

	if (!usb_cdc_present) {
		/* Force VCP port function to disabled if we haven't advertised VCP in our USB descriptor */
		hw_usb_vcpport = HWFLYINGF7_USB_VCPPORT_DISABLED;
	}
	...
	case HWFLYINGF7_USB_VCPPORT_DISABLED:
		break;
	case HWFLYINGF7_USB_VCPPORT_USBTELEMETRY:
		...
		break;
	case HWFLYINGF7_USB_VCPPORT_COMBRIDGE:
#if defined(PIOS_INCLUDE_COM)
		{
...
#endif	/* PIOS_INCLUDE_COM */
		break;
	case HWFLYINGF7_USB_VCPPORT_DEBUGCONSOLE:
#if defined(PIOS_INCLUDE_COM)
#if defined(PIOS_INCLUDE_DEBUG_CONSOLE)
		{
...
#endif	/* PIOS_INCLUDE_COM */
		break;
	case HWFLYINGF7_USB_VCPPORT_PICOC:
#if defined(PIOS_INCLUDE_COM)
		{
	...
	HwFlyingF7USB_HIDPortGet(&hw_usb_hidport);

	if (!usb_hid_present) {
		/* Force HID port function to disabled if we haven't advertised HID in our USB descriptor */
		hw_usb_hidport = HWFLYINGF7_USB_HIDPORT_DISABLED;
	}
	...
	case HWFLYINGF7_USB_HIDPORT_DISABLED:
		break;
	case HWFLYINGF7_USB_HIDPORT_USBTELEMETRY:
#if defined(PIOS_INCLUDE_COM)
		{
			uint8_t * rx_buffer = (uint8_t *) PIOS_malloc(PIOS_COM_TELEM_USB_RX_BUF_LEN);
			uint8_t * tx_buffer = (uint8_t *) PIOS_malloc(PIOS_COM_TELEM_USB_TX_BUF_LEN);
	...
	uint8_t hw_DSMxBind;
	HwFlyingF7DSMxBindGet(&hw_DSMxBind);
	...
	/* UART1 Port */
	uint8_t hw_uart1;
	HwFlyingF7Uart1Get(&hw_uart1);
	switch (hw_uart1) {
	case HWFLYINGF7_UART1_DISABLED:
		break;
	case HWFLYINGF7_UART1_GPS:
	...
	case HWFLYINGF7_UART1_DSM:
		...
		break;
	case HWFLYINGF7_UART1_HOTTSUMD:
	case HWFLYINGF7_UART1_HOTTSUMH:
	...
	/* UART2 Port */
	uint8_t hw_uart2;
	HwFlyingF7Uart2Get(&hw_uart2);
	switch (hw_uart2) {
	case HWFLYINGF7_UART2_DISABLED:
		break;
	case HWFLYINGF7_UART2_TELEMETRY:
...
#endif	/* PIOS_INCLUDE_DSM */
		break;
	case HWFLYINGF7_UART2_HOTTSUMD:
	case HWFLYINGF7_UART2_HOTTSUMH:
#if defined(PIOS_INCLUDE_HSUM)
		{
			enum pios_hsum_proto proto;
			switch (hw_uart2) {
...
#endif	/* PIOS_INCLUDE_HSUM */
		break;
	case HWFLYINGF7_UART2_DEBUGCONSOLE:
...
#endif	/* PIOS_INCLUDE_DEBUG_CONSOLE */
		break;
	case HWFLYINGF7_UART2_COMBRIDGE:
#if defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif
		break;
	case HWFLYINGF7_UART2_MAVLINKTX:
		...
		break;
	case HWFLYINGF7_UART2_MAVLINKTX_GPS_RX:
...
#endif	/* PIOS_INCLUDE_MAVLINK */
		break;
	case HWFLYINGF7_UART2_FRSKYSENSORHUB:
		...
		break;
	case HWFLYINGF7_UART2_LIGHTTELEMETRYTX:
...
#endif /* PIOS_INCLUDE_PICOC */
		break;
	case HWFLYINGF7_UART2_FRSKYSPORTTELEMETRY:
	...
	/* UART3 Port */
	uint8_t hw_uart3;
	HwFlyingF7Uart3Get(&hw_uart3);
	switch (hw_uart3) {
	case HWFLYINGF7_UART3_DISABLED:
		break;
	case HWFLYINGF7_UART3_TELEMETRY:
#if defined(PIOS_INCLUDE_TELEMETRY_RF) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif	/* PIOS_INCLUDE_DSM */
	case HWFLYINGF7_UART3_HOTTSUMD:
	case HWFLYINGF7_UART3_HOTTSUMH:
#if defined(PIOS_INCLUDE_HSUM)
		{
			enum pios_hsum_proto proto;
			switch (hw_uart3) {
...
#endif	/* PIOS_INCLUDE_MAVLINK */
		break;
	case HWFLYINGF7_UART3_FRSKYSENSORHUB:
#if defined(PIOS_INCLUDE_FRSKY_SENSOR_HUB) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif /* PIOS_INCLUDE_FRSKY_SENSOR_HUB */
		break;
	case HWFLYINGF7_UART3_LIGHTTELEMETRYTX:
#if defined(PIOS_INCLUDE_LIGHTTELEMETRY)
...
#endif /* PIOS_INCLUDE_PICOC */
		break;
	case HWFLYINGF7_UART3_FRSKYSPORTTELEMETRY:
#if defined(PIOS_INCLUDE_FRSKY_SPORT_TELEMETRY)
	...
	/* UART4 Port */
	uint8_t hw_uart4;
	HwFlyingF7Uart4Get(&hw_uart4);
	switch (hw_uart4) {
	case HWFLYINGF7_UART4_DISABLED:
		break;
	case HWFLYINGF7_UART4_GPS:
#if defined(PIOS_INCLUDE_GPS) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
	...
	/* UART5 Port */
	uint8_t hw_uart5;
	HwFlyingF7Uart5Get(&hw_uart5);
	switch (hw_uart5) {
	case HWFLYINGF7_UART5_DISABLED:
		break;
	case HWFLYINGF7_UART5_GPS:
#if defined(PIOS_INCLUDE_GPS) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
	...
	uint8_t hw_rcvrport;
	HwFlyingF7RcvrPortGet(&hw_rcvrport);

	switch (hw_rcvrport) {
	case HWFLYINGF7_RCVRPORT_DISABLED:
		break;
	case HWFLYINGF7_RCVRPORT_PWM:
		...
		break;
	case HWFLYINGF7_RCVRPORT_PPM:
	case HWFLYINGF7_RCVRPORT_PPMOUTPUTS:
		...
		break;
	case HWFLYINGF7_RCVRPORT_PPMPWM:
	...
	switch (hw_rcvrport) {
		...
		case HWFLYINGF7_RCVRPORT_PPM:
			...
			break;
		case HWFLYINGF7_RCVRPORT_PPMOUTPUTS:
		case HWFLYINGF7_RCVRPORT_OUTPUTS:
#ifdef PIOS_INCLUDE_SERVO
	...
	HwFlyingF7MPU6050DLPFGet(&hw_mpu6050_dlpf);
	enum pios_mpu60x0_filter mpu6050_dlpf = \
	    (hw_mpu6050_dlpf == HWFLYINGF7_MPU6050DLPF_256) ? PIOS_MPU60X0_LOWPASS_256_HZ : \
	    (hw_mpu6050_dlpf == HWFLYINGF7_MPU6050DLPF_188) ? PIOS_MPU60X0_LOWPASS_188_HZ : \
	    (hw_mpu6050_dlpf == HWFLYINGF7_MPU6050DLPF_98) ? PIOS_MPU60X0_LOWPASS_98_HZ : \
	    (hw_mpu6050_dlpf == HWFLYINGF7_MPU6050DLPF_42) ? PIOS_MPU60X0_LOWPASS_42_HZ : \
	    (hw_mpu6050_dlpf == HWFLYINGF7_MPU6050DLPF_20) ? PIOS_MPU60X0_LOWPASS_20_HZ : \
	    (hw_mpu6050_dlpf == HWFLYINGF7_MPU6050DLPF_10) ? PIOS_MPU60X0_LOWPASS_10_HZ : \
	    (hw_mpu6050_dlpf == HWFLYINGF7_MPU6050DLPF_5) ? PIOS_MPU60X0_LOWPASS_5_HZ : \
	    pios_mpu6050_cfg.default_filter;
	PIOS_MPU6050_SetLPF(mpu6050_dlpf);

	uint8_t hw_mpu6050_samplerate;
	HwFlyingF7MPU6050RateGet(&hw_mpu6050_samplerate);
	uint16_t mpu6050_samplerate = \
	    (hw_mpu6050_samplerate == HWFLYINGF7_MPU6050RATE_200) ? 200 : \
	    (hw_mpu6050_samplerate == HWFLYINGF7_MPU6050RATE_333) ? 333 : \
	    (hw_mpu6050_samplerate == HWFLYINGF7_MPU6050RATE_500) ? 500 : \
	    (hw_mpu6050_samplerate == HWFLYINGF7_MPU6050RATE_666) ? 666 : \
	    (hw_mpu6050_samplerate == HWFLYINGF7_MPU6050RATE_1000) ? 1000 : \
	    (hw_mpu6050_samplerate == HWFLYINGF7_MPU6050RATE_2000) ? 2000 : \
	    (hw_mpu6050_samplerate == HWFLYINGF7_MPU6050RATE_4000) ? 4000 : \
	    (hw_mpu6050_samplerate == HWFLYINGF7_MPU6050RATE_8000) ? 8000 : \
...
#if defined(PIOS_INCLUDE_HMC5883)
	{
		...
		HwFlyingF7MagnetometerGet(&Magnetometer);

		if (Magnetometer == HWFLYINGF7_MAGNETOMETER_EXTERNALI2C) {
			...
			enum pios_hmc5883_orientation hmc5883_orientation = \
				...
				(ExtMagOrientation == HWFLYINGF7_EXTMAGORIENTATION_TOP90DEGCW) ? PIOS_HMC5883_TOP_90DEG : \
				(ExtMagOrientation == HWFLYINGF7_EXTMAGORIENTATION_TOP180DEGCW) ? PIOS_HMC5883_TOP_180DEG : \
				(ExtMagOrientation == HWFLYINGF7_EXTMAGORIENTATION_TOP270DEGCW) ? PIOS_HMC5883_TOP_270DEG : \
				(ExtMagOrientation == HWFLYINGF7_EXTMAGORIENTATION_BOTTOM0DEGCW) ? PIOS_HMC5883_BOTTOM_0DEG : \
				(ExtMagOrientation == HWFLYINGF7_EXTMAGORIENTATION_BOTTOM90DEGCW) ? PIOS_HMC5883_BOTTOM_90DEG : \
				(ExtMagOrientation == HWFLYINGF7_EXTMAGORIENTATION_BOTTOM180DEGCW) ? PIOS_HMC5883_BOTTOM_180DEG : \
				(ExtMagOrientation == HWFLYINGF7_EXTMAGORIENTATION_BOTTOM270DEGCW) ? PIOS_HMC5883_BOTTOM_270DEG : \
